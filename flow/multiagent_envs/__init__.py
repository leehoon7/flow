...
from flow.multiagent_envs.New_traffic_light_grid import New_MultiTrafficLightGridPOEnv
...
__all__ = ['MultiEnv', 'MultiAgentAccelEnv', 'MultiWaveAttenuationPOEnv',
           'MultiTrafficLightGridPOEnv','New_MultiTrafficLightGridPOEnv', 'MultiAgentHighwayPOEnv']
